  ...
  /* Empty constructor - might be a good idea here to put the code that 
   ...
   Five: 0.monster related:
         ...
         9.randomWeight;
             ...
             1.middle influence;
             2.high influence;
         10.green strawberry related
             1:eat the green strawberry
             0:do not eat the green strawberry
         11.red strawberry related
             1:eat the red strawberry
             0:do not eat the red strawberry
  */
  public MyCreature(){
    chromosome = new float[11];
...
//      Int greenWeight =0;
      ...
      //whether food is nearby
      for(int i=18;i<27;i++){
        if (percepts[i]>0){
          //actions[27-i]=chromosome[2]*chromosome[5];
          actions[27-i]=chromosome[2]*chromosome[5];
          if (percepts[i]==1){
            actions[9]=chromosome[6]*chromosome[9];
          }else{
            actions[9]=chromosome[7]*chromosome[10];
          }
        }
      }
      //random movement
      actions[10]=percepts[10]*chromosome[8];
